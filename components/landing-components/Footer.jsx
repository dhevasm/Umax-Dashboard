                ...
                <div className="flex flex-wrap justify-center -mx-4">
                    <div className="w-full px-4 sm:w-2/3 lg:w-4/12 2xl:w-3/12">
                        <div className="w-full mb-10">
                            ...
                            <div className="flex items-center justify-start -mx-3">
                                <a href="javascript:void(0)" className="px-3 text-white hover:text-gray-900">
                    ...
                    <div className="w-full px-4 sm:w-1/2 lg:w-2/12 2xl:w-2/12">
                        <div className="w-full mb-10">
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0)" className="inline-block text-base leading-loose text-white/70 hover:text-white mb-2">
                                        About Us
                                    </a>
                                </li>
                                <li>
                ...
                <div className="flex justify-between -mx-4">
                    ...
                    <div className="w-full px-4 text-center sm:w-auto">
                        <div className="flex items-center justify-center">
                            <a href="javascript:void(0)" className="px-4 text-base text-white/70 hover:text-white">
                                Privacy Policy
                            </a>
                            <a href="javascript:void(0)" className="px-4 text-base text-white/70 hover:text-white">
                                Terms of Use
