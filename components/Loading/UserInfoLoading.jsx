    ...
    <div className="text-black me-5 hover:cursor-pointer relative">
        ...
        <div className="profile-dropdown hidden absolute z-10 mt-3 -right-7 p-3 bg-white border border-gray-100 shadow-md w-48 transition-all duration-3000">
            <div className="flex flex-col mb-2">
                <div className="text-sm font-medium bg-gray-300 text-transparent rounded-md animate-pulse w-36 h-4"></div>
            </div>
            <div className="border-t border-gray-300"></div>
            <div className="text-sm bg-gray-300 text-transparent rounded-md animate-pulse h-3 w-24 mt-2 mb-2"></div>
            <div className="text-sm bg-gray-300 text-transparent rounded-md animate-pulse h-3 w-24 mt-2 mb-2"></div>
            <div className="text-sm bg-gray-300 text-transparent rounded-md animate-pulse h-3 w-24 mt-2 mb-2"></div>
            <div className="border-t border-gray-300"></div>
            <div className="text-sm bg-gray-300 text-transparent rounded-md animate-pulse h-3 w-32 mt-2"></div>
        </div>
    </div>
  )
}
