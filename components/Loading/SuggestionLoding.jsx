...
const SuggestionLoding = () => {
  return (
    <div className={`w-full p-7 rounded-lg shadow-lg bg-gray-100 mt-5 transition-all`}>
        ...
        <div className="flex justify-between md:gap-0 gap-2 items-center">
            <div className="mt-3 w-60 h-5 bg-gray-300 rounded animate-pulse"></div>
            <div className="text-sm self-end w-20 h-5 bg-gray-300 rounded animate-pulse"></div>
        </div>
    </div>
  )
}
