  ...
  return (
    <div className={`bg-gray-100 p-4 pt-5 pb-5 rounded-lg w-full transition-all shadow-lg animate-pulse`}>
        ...
        <div className="flex justify-between items-center animate-pulse-slow">
            <h1 className={`text-2xl text-gray-300 text-nowrap`}>
                <span className="w-24 h-2 bg-gray-300 rounded-lg animate-pulse">Lorem</span>
            </h1>
            <button className="relative bottom-7 animate-pulse-slow">
                <i className="fas fa-info-circle text-xs text-gray-300">
                    <svg className="w-6 h-6 text-gray-300 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
