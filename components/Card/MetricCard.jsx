...
export default function MetricCard({Title, Value}){
    return (
        <>
            <div className="bg-white dark:bg-slate-700 rounded-lg shadow-lg p-3 w-[30%] transition-all">
                ...
                <div className="mt-4 flex items-center gap-2">
                    <span className="text-[10px] text-gray-500 dark:text-gray-400">Total {Title} Compared to last 7 days</span>
