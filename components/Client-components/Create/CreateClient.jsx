                ...
                <div className="overflow-y-auto max-h-[70vh]">
                    <form onSubmit={formik.handleSubmit}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                            ...
                            <DetailItem label={t('password')} value={formik.values.password} id="password" type="password" handleChange={formik.handleChange} handleBlur={formik.handleBlur} icon={MdEmail} t={t} holder={t('holder-password')} Country={null} City={null} />
                            <DetailItem label={t('confirm')} value={formik.values.confirm_password} id="confirm_password" type="password" handleChange={formik.handleChange} handleBlur={formik.handleBlur} icon={MdEmail} t={t} holder={t('holder-confirm')} Country={null} City={null} />
