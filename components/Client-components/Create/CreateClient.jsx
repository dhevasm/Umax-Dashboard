...
import { FaUser, FaRegAddressBook, FaRegClock, FaNotesMedical, FaFlag, FaBuilding, FaCity, FaPhone, FaUserLock, FaInfo, FaInfoCircle, FaTextHeight, FaNewspaper, FaFileWord } from 'react-icons/fa';
                ...
                <div className="overflow-y-auto max-h-[70vh]">
                    <form onSubmit={formik.handleSubmit}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                            ...
                            <DetailItem label={t('password')} value={formik.values.password} error={formik.errors.password} touched={formik.touched.password} id="password" type="password" handleChange={formik.handleChange} handleBlur={formik.handleBlur} icon={FaUserLock} t={t} holder={t('holder-password')} Country={null} City={null} />

                            <DetailItem label={t('confirm')} value={formik.values.confirm_password} error={formik.errors.confirm_password} touched={formik.touched.confirm_password} id="confirm_password" type="password" handleChange={formik.handleChange} handleBlur={formik.handleBlur} icon={FaUserLock} t={t} holder={t('holder-confirm')} Country={null} City={null} />

                            <DetailItem label={t('country')} value={formik.values.country} error={formik.errors.country} touched={formik.touched.country} id="country" type="select" handleChange={formik.handleChange} handleBlur={formik.handleBlur} icon={FaFlag} t={t} holder={t('holder-country')} Country={Country} City={null} />
