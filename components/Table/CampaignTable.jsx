                ...
                <div className="overflow-x-auto rounded-md">
                    <table className="w-full border">
                        <thead className="bg-blue-600">
                            ...
                            <th className="px-2 py-2 border text-white">Name</th>
                            <th className="px-2 py-2 border text-white">Client</th>
                            <th className="px-2 py-2 border text-white">Platform</th>
                            <th className="px-2 py-2 border text-white">Account</th>
                            <th className="px-2 py-2 border text-white">Objective</th>
                            <th className="px-2 py-2 border text-white">Start Date</th>
                            <th className="px-2 py-2 border text-white">Status</th>
                            <th className="px-2 py-2 border text-white">Action</th>
                            </tr>
                        </thead>
                        <tbody>
