...
function FacebookgetActoken() {
    ...
    const steps = [
      {
        text: `${t("fb-t1")}` , 
        img: "/assets/FacebookGetToken/FBToken1.png", 
      },
      {
        text: `${t("fb-t2")}`,
        img: "/assets/FacebookGetToken/FBToken2.png",
      },
      {
        text: `${t("fb-t3")}`,
        img: "/assets/FacebookGetToken/FBToken3.png",
      },
    ];
          ...
          <div className="fixed z-40 w-screen h-screen top-0 left-0" onClick={closeModal}></div>
            <div className="bg-white dark:bg-slate-800 text-black dark:text-white rounded-sm w-[700px] p-6 shadow-lg z-50">
              ...
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold">{t("fb-title")}</h2>
...
export default FacebookgetActoken