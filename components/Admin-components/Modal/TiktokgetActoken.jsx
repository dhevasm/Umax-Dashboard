...
function TiktokgetActoken() {
    ...
    const steps = [
      {
        text: `${t("tiktok-t1")}` , 
        img: "/assets/TiktokGetToken/Tiktok1.png", 
      },
      {
        text: `${t("tiktok-t2")}`,
        img: "/assets/TiktokGetToken/Tiktok2.png",
      },
      {
        text: `${t("tiktok-t3")}`,
        img: "/assets/TiktokGetToken/Tiktok3.png",
      },
    ];
          ...
          <div className="fixed z-40 w-screen h-screen top-0 left-0" onClick={closeModal}></div>
            <div className="bg-white dark:bg-slate-800 text-black dark:text-white rounded-sm w-[700px] p-6 shadow-lg z-50">
              ...
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold">{t("tiktok-title")}</h2>
...
export default TiktokgetActoken