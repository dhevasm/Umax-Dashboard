        ...
        {/* Sidebar */}
            <div className="fixed mt-20 m-3 left-0 w-[300px] h-screen bg-white rounded-lg flex flex-col items-center px-3 z-10 transition-transform shadow-md pb-28" ref={sidebar}>
                ...
                <div className="w-full flex justify-center">
                    <input className="text-black m-1 p-2 rounded-xl border w-full border-gray-300 focus:outline-blue-400" type="text" placeholder="Search" onChange={(event) => setSearchTerm(event.target.value)}/>
                </div>
