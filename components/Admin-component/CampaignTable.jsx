        ...
        <>
            <div className="w-full">
                <div className="flex flex-col md:flex-row justify-between items-center mb-10">
                    <h1 className="text-3xl font-bold dark:text-white uppercase flex gap-2"> <RiMegaphoneLine size={35}/> Campaigns</h1>
                                        ...
                                        currentcampaigns.length > 0 ? currentcampaigns.map((campaign, index) => {
                                            return (
                                                <tr key={index} className="hover:bg-gray-100 dark:hover:bg-slate-400 dark:odd:bg-slate-600 dark:even:bg-slate-700 hover:cursor-pointer transition-colors duration-300" onClick={() => showModal("Edit", campaign._id)}>
                                                    ...
                                                    <td scope="row" className="px-5 py-3 border dark:border-gray-500 font-medium  whitespace-nowrap">{campaign.status == 1 ? "Active" : campaign.status == 3 ? "Complete" : "Draft"}</td>
