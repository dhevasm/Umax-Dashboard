        ...
        <>
            <div className="w-full h-full flex flex-wrap gap-5">
                ...
                <div className="w-full xl:h-[450px] h-[900px] flex flex-col md:flex-row gap-7 mb-3">
                    ...
                    <div className="xl:w-2/3 max-h-[450px] h-full bg-white rounded-sm shadow-lg p-5">
                        <ChartTwo />
                    </div>
                </div>
                <div className="w-full xl:h-[450px] h-[900px] flex flex-col md:flex-row gap-7 mb-3">
                    ...
                    <div className="xl:w-2/5 max-h-[450px] h-full bg-white rounded-sm shadow-lg p-5">
                        <ChartThree />
                    </div>
                </div>
                <div className="w-full h-fit flex xl:flex-row lg:flex-col md:flex-col sm:flex-col gap-7 mb-3">
                    <div className="w-full h-fit bg-white rounded-sm shadow-lg p-5 overflow-y-auto">
