...
const Footer = () => {
  return (
    <div>
        <footer className="relative z-10 bg-blue-600 max-w-full">
        ...
        <div className="container pt-14 lg:pt-20">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-4/12 2xl:w-3/12">
                ...
                <a href="javascript:void(0)" className="mb-6 inline-block max-w-[160px]">
                    <img src="src/assets/images/logo/logo-white.svg" alt="logo" className="max-w-full" />
                </a>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 2xl:w-3/12">
                ...
                <a href="javascript:void(0)" className="flex items-center mb-8 text-gray-7 hover:text-white">
                    <div className="mr-5 w-full max-w-[70px] overflow-hidden rounded">
                    <img src="src/assets/images/footers/footer-04/blog-01.jpg" alt="image" className="w-full" />
                    </div>
                    <p className="text-base">I think really important to design...</p>
                </a>
                <a href="javascript:void(0)" className="flex items-center mb-8 text-gray-7 hover:text-white">
                    <div className="mr-5 w-full max-w-[70px] overflow-hidden rounded">
                    <img src="src/assets/images/footers/footer-04/blog-02.jpg" alt="image" className="w-full" />
                    </div>
        ...
        <div className="mt-12 bg-[#101541] py-8 lg:mt-[60px]">
            ...
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="flex justify-center my-1 md:justify-start">
                    <p className="text-base text-gray-7">© 2025 TailGrids</p>
                </div>
                </div>
                <div className="w-full px-4 md:w-2/3 lg:w-1/2">
                <div className="my-1">
                    <div className="flex flex-wrap items-center justify-center -mx-3 md:justify-end">
                    <a href="javascript:void(0)" className="px-3 text-base text-gray-7 hover:text-white">
                        Privacy policy
                    </a>
                    <a href="javascript:void(0)" className="px-3 text-base text-gray-7 hover:text-white">
                        Legal notice
